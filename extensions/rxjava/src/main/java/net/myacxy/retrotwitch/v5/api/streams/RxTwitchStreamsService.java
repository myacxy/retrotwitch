...
public interface RxTwitchStreamsService {
    ...
    Observable<StreamResponse> getStreamByUser(@Path("channel_id") long channelId, @Query("stream_type") StreamType streamType);
     ...
     */
    @GET("streams")
    Observable<StreamsResponse> getLiveStreams(
