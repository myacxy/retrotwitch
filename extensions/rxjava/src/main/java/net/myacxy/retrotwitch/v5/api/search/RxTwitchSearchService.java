...
public interface RxTwitchSearchService {
     ...
     */
    @GET("search/channels")
    Single<Response<SearchChannelsResponse>> searchChannels(
     ...
     */
    @GET("search/games")
    Single<Response<SearchGamesResponse>> searchGames(
            @Query("query") String query,
     ...
     */
    @GET("search/streams")
    Single<Response<SearchStreamsResponse>> searchStreams(
            @Query("query") String query,
